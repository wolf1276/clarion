...
_Zero databases. Zero infrastructure costs. 100% Client-Side Processing._
...
- **🗣️ Natural Language to SQL:** Ask questions like _"Show me the total sales by region and category"_ and watch the magic happen.
...
5. **Interactive Queries:** When the user types a manual query, the frontend sends the _schema only_ (no user data) and the natural language prompt to `/api/query`.
